...
- **playlist.m3u8:**
  A standard M3U playlist. If you're using this playlist, make sure your IPTV application allows the setting of a custom `Referer` header. The `Referer` must be set to `https://embedsports.top/` in order to access the streams. Failure to set the `Referer` will result in a 403 error when attempting to stream.

  **Playlist:** `https://tinyurl.com/wsu-m3u1`  
  **EPG URL:** `https://tinyurl.com/wsu-epg`  
...
- **tivimate_playlist.m3u8:**
  ...
  **Playlist:** `https://tinyurl.com/wsu-m3u2`  
   **EPG URL:** `https://tinyurl.com/wsu-epg`  
   **Referer:** `Included`
...
- **kodi_playlist.m3u8:**
  ...
  **Playlist:** `https://tinyurl.com/wsu-m3u3`  
  **EPG URL:** `https://tinyurl.com/wsu-epg`  
  **Referer:** `Included`
...
- **vlc_playlist.m3u8:**
  ...
  **Playlist:** `https://tinyurl.com/wsu-m3u4`
  **EPG URL:** `https://tinyurl.com/wsu-epg`  
  **Referer:** `Included`
...
This repository has no control over the streams, links, or the legality of the content provided by [Streamed](http://href.li/?https://strmd.link/). It is the end user's responsibility to ensure the legal use of these streams, and we strongly recommend verifying that the content complies with the laws and regulations of your country before use.
